...
# edited every time a tool is added or a group is loaded -- it read 31 while a --grail image served
# 33 -- and editing it says nothing about whether the surface is right. Asking the server how many
# tools its toolsets declare, and checking tools/list agrees, is a real assertion (everything
