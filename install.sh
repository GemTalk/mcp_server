...
# a stock (String-configured) image, which is why McpBase>>parseBody: narrows with #asString after
# #decodeFromUTF8 -- see the Unicode trap in section 5 of the kernel JSON Unicode report.
#
