...
#                           was a guess at when nobody is waiting any more, and a client that stops
#                           waiting now says so, by a notifications/cancelled. A deadline
...
#                           far more often than a runaway, and it was not even fitted to real client
#                           patience: measured 2026-08-31, Claude Code ran a 150-second call to
#                           completion and took the answer. Set a number of seconds where the clients
