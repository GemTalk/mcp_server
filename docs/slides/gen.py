...
SLIDES = [
 ...
 ("a-request", "The hop &#8212; one string, non-blocking",
  ...
  "`printString`-quoted, so a request body cannot smuggle anything into the worker&#8217;s compiler &#8212; "
  "load-bearing for the server **title** in particular, which is free-form operator prose.",
